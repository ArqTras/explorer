var config = {
    ...
    coinUnitPlaces: 9,
    txMinConfirms: 4,         // corresponds to CRYPTONOTE_DEFAULT_TX_SPENDABLE_AGE in Arqma
    txCoinbaseMinConfirms: 18, // corresponds to CRYPTONOTE_MINED_MONEY_UNLOCK_WINDOW in Arqma
    coinSymbol: 'ARQ',
    openAliasPrefix: "arq",
    coinName: 'ArQmA',
    coinUriPrefix: 'arqma:',
